...
collections:
  ...
  - name: "ai_drafts"
    ...
    fields:
      ...
      - { label: "Web Scraping URL Links", name: "linkAiDraft", widget: "list", required: false, hint: https://someportal.com/breaking-news-today, fields: [{ label: "Link", name: "linkUrl", widget: "string" }] }
